 ...
 */
   ...
   Configure::write('Galleries.selected_file_name', 'selected.txt' );
   
   Configure::write('Image.width', 200 );
   Configure::write('Image.pics_per_row', 4 );
   
   Configure::write('Masonry', true);
 ...
 */
  Configure::write('Session.cookie', 'MARKAB');
 ...
 */
  Configure::write('Security.salt', 'leho3h12oi3uho8712h3p1293h�p12938h2p1938h12p938hi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
  Configure::write('Security.cipherSeed', '8712312638791236987123698712369821231232136541896418949');
